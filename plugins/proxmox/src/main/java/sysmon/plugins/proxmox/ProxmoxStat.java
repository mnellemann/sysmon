...
public class ProxmoxStat {

    private static final Logger log = LoggerFactory.getLogger(ProxmoxStat.class);
    ...
    public ProxmoxStat(InputStream inputStream) throws IOException {
